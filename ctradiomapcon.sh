#!/bin/bash
#SBATCH --job-name=consistency_train_radiomaps_conditional
...
# Run conditional consistency training for radio maps
python scripts/cm_train_radio.py \
