...
#SBATCH --mem=48G
#SBATCH --gres=gpu:1
#SBATCH --output=consistency_train_%j.out
#SBATCH --error=consistency_train_%j.err
...
# Run consistency training on single GPU (no MPI) - RESUME from step 110k
OPENAI_LOGDIR=/home/pariamdz/projects/def-hinat/pariamdz/RadioDiff/consistency_models/checkpoints python scripts/cm_train.py \
  --resume_checkpoint /home/pariamdz/projects/def-hinat/pariamdz/RadioDiff/consistency_models/checkpoints/model460000.pt \
